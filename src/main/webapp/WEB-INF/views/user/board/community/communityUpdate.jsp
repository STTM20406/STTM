...
<section class="contents">
	<form action="/postModify" method="post" id="frm" role="form" enctype="multipart/form-data">
				...
				<input type="text" id="write_id" name="write_id" value="${writeInfo.write_id }"/>
				<input type="text" id="board_id" name="board_id" value="${writeInfo.board_id }"/>
								...
								<div>
									...
									<div class="col-sm-10">
										...
										<textarea name="smarteditor" id="smarteditor" rows="10"
											cols="100" style="width: 766px; height: 412px;">${writeInfo.content }</textarea>
									</div>
								</div>
